...
public record DamageValue(ResourceKey<DamageType> damageType, int amount) {
    public static final Codec<DamageValue> CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                    ...
                    Codec.INT.fieldOf("amount").forGetter(DamageValue::amount)
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, DamageValue> STREAM_CODEC = StreamCodec.composite(
            ...
            ByteBufCodecs.VAR_INT, DamageValue::amount,
            DamageValue::new
    );
