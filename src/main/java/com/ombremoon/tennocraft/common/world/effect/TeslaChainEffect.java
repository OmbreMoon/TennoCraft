...
public class TeslaChainEffect extends StatusEffect {
    public TeslaChainEffect(MobEffectCategory category, int maxStacks, int duration, int color) {
        super(category, maxStacks, duration, color);
    }

    @Override
    public ResourceKey<DamageType> damageProc() {
        return TCDamageTypes.ELECTRICITY;
    }
}
