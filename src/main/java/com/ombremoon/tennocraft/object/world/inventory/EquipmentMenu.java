...
public class EquipmentMenu extends AbstractContainerMenu {
    ...
    public EquipmentMenu(int id, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
        this(id, inventory, inventory.player.level().getBlockEntity(friendlyByteBuf.readBlockPos()));
    }

    public EquipmentMenu(int id, Inventory inventory, BlockEntity blockEntity) {
